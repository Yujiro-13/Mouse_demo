...
ADC::ADC(IRLED_FR* led_fr, IRLED_FL* led_fl, IRLED_R* led_r, IRLED_L* led_l, adc_channel_t VBATT) : adc1(nullptr), led_FR(*led_fr), led_FL(*led_fl), led_R(*led_r), led_L(*led_l)
{
...
void ADC::SetIRLED(uint8_t led, IRLED_FR& led_FR, IRLED_FL& led_FL, IRLED_R& led_R, IRLED_L& led_L)
{
